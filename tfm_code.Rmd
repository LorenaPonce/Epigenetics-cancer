...
ntCOAD <- topTable (efit, number=nrow(efit), coef="COADsamples", adjust="fdr", lfc = 2^0.2, p.value = 0.01)#, genelist=ann450kSub
ntBRCA <- topTable (efit, number=nrow(efit), coef="BRCAsamples", adjust="fdr", lfc = 2^0.2, p.value = 0.01)
ntPRAD <- topTable (efit, number=nrow(efit), coef="PRADsamples", adjust="fdr", lfc = 2^0.2, p.value = 0.01)
ntLUAD <- topTable (efit, number=nrow(efit), coef="LUADsamples", adjust="fdr", lfc = 2^0.2, p.value = 0.01)
```
