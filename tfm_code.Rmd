...
Seguidamente se procede a calcular el número óptimo de k para PRAD:
...
```{r, eval=FALSE}
## No se puede evaluar por falta de memoria interna
...
En primer lugar se va a tratar a llevar a cabo el algoritmo Support Vector Machine seguido de Random Forest, ambos son dos tipos de algoritmos englobados dentro del térmico *Supervised Learning* dado que ambos precisan de etiquetas para clasificar los datos. Además ambos son algoritmos tanto de clasificación como de regresión. Uno de los principales problemas que vamos a encontrar será el bajo número de pacientes tumorales en algunas de las cohortes como COAD y LUAD. 
